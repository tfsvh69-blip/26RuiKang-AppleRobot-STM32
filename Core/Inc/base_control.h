...
/* 旋转到绝对 yaw 角度，输入范围建议 -180 到 +180，内部自动选择最短旋转方向。 */
...
/* 按绝对 yaw 角度保持航向前进，直到正前方距离小于停止阈值。 */
...
/* 按绝对 yaw 角度闭环前进直到前方距离小于阈值，使用 Base_RotateToGoalYaw 风格 PD 控制（带减速区/精调区/最小速度） */
